...
<body>
	...
	<div class="main-inner" id="mainCnt"
		style="width: 1520px; height: 800px; overflow: hidden; position: absolute; left: 30%; top: 20%; margin-left: -450px; margin-top: -220px; background-image: url('${pageContext.request.contextPath }/images/login.jpg')">
