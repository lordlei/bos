...
<head>
    ...
    <script type="text/javascript">
        ...
        function doAssociations() {//noassociationSelect
            //获取当前数据表格所有选中的行，返回数组
...
<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false"
    ...
    <div style="height:31px;overflow:hidden;" split="false" border="false">
        <div class="datagrid-toolbar">
            ...
            <script type="text/javascript">
                $("#save").click(function () {
                    var v = $("#submitDecidedzone").form("validate");
                    if (v) {
                        $("#submitDecidedzone").submit();
                    }
                })
            </script>
        </div>
    ...
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="submitDecidedzone" action="${pageContext.request.contextPath}/DecidedzoneAction_add.action"
              method="post">
                        ...
                        <script type="text/javascript">
                            $(function () {
                                ...
                                $("#associationBtn").click(function () {
                                    var rows = $("#grid").datagrid("getSelections");
                                    var id = rows[0].id;
                                    //为隐藏域customerDecidedZoneId赋值id
                                    $("input[name=id]").val(id);
                                    //提交表单前,为右侧下拉框中全部选中 为option属性添加selected
