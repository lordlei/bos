                            ...
                            $.post('${pageContext.request.contextPath}/RoleAction_listAjax.action',
                                function (data) {
						           for(var i=0;i<data.length;i++){
						               ...
						               $("#roleID").append('<input type="checkbox" name="roleIds" id="'+id+'" value="'+id+'"/><label for="'+id+'">'+name+'</label><br>');
                                   }
                                }
                            )
                        })
                    </script>
                    <%--<input type="checkbox" name="roleIds" id="roleIds" value=""/><label for="roleIds"></label>--%>
                </td>
            </tr>
        </table>
    </form>
